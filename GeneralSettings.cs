...
namespace WASender
{
    public partial class GeneralSettings : MyMaterialPopOp
    {
        ...
        private void materialButton1_Click(object sender, EventArgs e)
        {
            ...
            languageModelList.Add(new LanguageModel { name = "GoogleMapDataEExtractor", value = "Google Map Data Extractor" });

            languageModelList.Add(new LanguageModel { name = "Usethatwindowtosearchforbusinessesandwhensearchresultsareshown", value = "Use that window to search for businesses and when search results are shown \n click on the 'Start Grabing button to start the crawler." });
            languageModelList.Add(new LanguageModel { name = "PleaseSearchsomething", value = "Please Search something" });
            languageModelList.Add(new LanguageModel { name = "ImportInWaSender", value = "Import numbers" });
            languageModelList.Add(new LanguageModel { name = "EnterCountryCode", value = "Enter Country Code" });
            languageModelList.Add(new LanguageModel { name = "SearchYourQUeryonGMap", value = "Search Your QUery on G Map" });
            languageModelList.Add(new LanguageModel { name = "HitStart", value = "Hit Start" });
            languageModelList.Add(new LanguageModel { name = "Count", value = "Count" });
            languageModelList.Add(new LanguageModel { name = "ReviewCount", value = "Review Count" });
            languageModelList.Add(new LanguageModel { name = "Catagory", value = "Catagory" });
            languageModelList.Add(new LanguageModel { name = "MobileNumber", value = "Mobile Number" });
            languageModelList.Add(new LanguageModel { name = "Address", value = "Address" });
            languageModelList.Add(new LanguageModel { name = "Website", value = "Website" });
            languageModelList.Add(new LanguageModel { name = "PlusCode", value = "PlusCode" });
            languageModelList.Add(new LanguageModel { name = "AddCountryCode", value = "Add Country Code" });
            languageModelList.Add(new LanguageModel { name = "One", value = "1) " });
            languageModelList.Add(new LanguageModel { name = "Two", value = "2) " });
            languageModelList.Add(new LanguageModel { name = "Three", value = "3) " });
            //languageModelList.Add(new LanguageModel { name = "", value = "" });
            //languageModelList.Add(new LanguageModel { name = "", value = "" });
            //languageModelList.Add(new LanguageModel { name = "", value = "" });
            //languageModelList.Add(new LanguageModel { name = "", value = "" });
