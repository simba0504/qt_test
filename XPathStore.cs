...
namespace WASender
{
    public static class XPathStore
    {
        ...
        public static string GMap_MobileNumber = "//*[@data-tooltip='Copy phone number'] | //*[@data-tooltip='Copiar número de telefone'] | //button[starts-with(@data-item-id,'phone:tel:')] | //button[starts-with(@data-item-id,'phone:')]";
